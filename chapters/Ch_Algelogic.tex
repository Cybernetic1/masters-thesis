...
\end{tikzpicture}
\end{align}
This structure is reminiscent of the Transformer's \textbf{Self-Attention}.  What we're doing here is to move variables around;  this suggests that the Transformer is also capable of moving tokens around.  The syntactic manipulation ability of Transformers has been corroborated by others' research [cite].
