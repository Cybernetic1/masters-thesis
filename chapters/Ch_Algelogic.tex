...
\end{tikzpicture}
\end{align}
This structure is reminiscent of the Transformer's \textbf{Self-Attention}.  What we're doing here is to move variables around;  this implies that the Transformer is capable of moving tokens around.  The syntactic manipulation ability of Transformers has been corroborated by others' research [cite].
