...
\textbf{Legend:}  The purple {\LARGE\color{purple!60}\RIGHTarrow} indicates \textbf{internal data} supplied by the Transformer, similar to the Q,K,V matrices in traditional Transformers.  They are modified through ``learning'' or training.  The 3 black \RIGHTarrow \ are the \textbf{inputs} to the Transformer, this is matched with the 3 \textbf{outputs} on the right of the diagram.
